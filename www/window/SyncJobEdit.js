                            ...
                            change: function (field, localStore) {
                                ...
                                if (view.syncDirectionPush) {
                                    let localNs = view
                                        ...
                                        .getValue();
                                    view.down('pbsGroupFilter').setLocalNamespace(
                                        localStore,
                                        localNs,
                                    );
                                }
                    ...
                    },
                    {
                        ...
                        listeners: {
                            change: function (field, localNs) {
                                ...
                                let remoteNs = view
                                    .down('pbsRemoteNamespaceSelector[name=remote-ns]')
                                    .getValue();
                    ...
                    },
                    {
                        ...
                        listeners: {
                            change: function (f, value) {
                                let me = this;
                                let remoteStoreField = me
                                    .up('pbsSyncJobEdit')
                                    .down('field[name=remote-store]');
                                remoteStoreField.setRemote(value);
                                let rateLimitField = me
                                    .up('pbsSyncJobEdit')
                                    .getVisibleRateLimitField();
                                rateLimitField.setDisabled(!value);
                                if (!value) {
                                    rateLimitField.setValue(null);
                                }
                                let remoteNamespaceField = me
                                    .up('pbsSyncJobEdit')
                        ...
                        listeners: {
                            change: function (field, value) {
                                ...
                                if (!view.syncDirectionPush) {
                                    me.up('tabpanel')
                                        .down('pbsGroupFilter')
                                        .setRemoteDatastore(remote, value);
                                } else {
                                    let localStore = me
                                        .up('pbsSyncJobEdit')
                                        .down('field[name=store]')
                                        .getValue();
                                    me.up('tabpanel')
                                        .down('pbsGroupFilter')
                                        .setLocalDatastore(localStore);
                                }
                            },
                        },
                    },
                        ...
                        listeners: {
                            change: function (field, remoteNs) {
                                ...
                                if (!view.syncDirectionPush) {
                                    me.up('tabpanel')
                                        .down('pbsGroupFilter')
                                        .setRemoteNamespace(remote, remoteStore, remoteNs);
                                }
                ...
                advancedColumn2: [
                    {
                        ...
                        autoEl: {
                            tag: 'div',
                            'data-qtip': gettext(
                                'Sync only encrypted backup snapshots, exclude others.',
                            ),
                        },
                        uncheckedValue: false,
                        value: false,
